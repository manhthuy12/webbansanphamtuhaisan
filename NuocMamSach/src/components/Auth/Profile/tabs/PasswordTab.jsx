...
export default function PasswordTab() {
  ...
  const showPassword = (value) => {
    ...
    if (value === "old_password") {
      setOldPass(password.type === "password" ? "show-password" : "hide-password");
      password.type = password.type === "password" ? "text" : "password";
    }
    if (value === "new_password") {
      setNewPass(password.type === "password" ? "show-password" : "hide-password");
      password.type = password.type === "password" ? "text" : "password";
    }
    if (value === "confirm_password") {
      setConfirmPass(password.type === "password" ? "show-password" : "hide-password");
      password.type = password.type === "password" ? "text" : "password";
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      await changePassword(userInfo?.id, data);
      ...
      <div className="w-full flex xl:flex-row flex-col-reverse space-x-5 xl:items-center">
        <div className="w-[397px] mb-10">
          <div className="input-field mb-6">
            <label className="input-label text-qgray text-sm block mb-2.5" htmlFor="old_password">
              Mật khẩu cũ*
            </label>
            <div className="input-wrapper border border-[#E8E8E8] w-full h-[58px] overflow-hidden relative ">
              ...
              />
              <div className="absolute right-6 bottom-[17px] z-10 cursor-pointer" onClick={() => showPassword("old_password")}>
          ...
          <div className="input-field mb-6">
            ...
            <div className="input-wrapper border border-[#E8E8E8] w-full h-[58px] overflow-hidden relative ">
              ...
              />
              <div className="absolute right-6 bottom-[17px] z-10 cursor-pointer" onClick={() => showPassword("new_password")}>
          ...
          <div className="input-field mb-6">
            ...
            <div className="input-wrapper border border-[#E8E8E8] w-full h-[58px] overflow-hidden relative ">
              ...
              />
              <div className="absolute right-6 bottom-[17px] z-10 cursor-pointer" onClick={() => showPassword("confirm_password")}>
          ...
          <div className="w-full mt-[30px] flex justify-start">
            <div className="sm:flex sm:space-x-[30px] items-center">
              <div className="w-[180px] h-[50px]">
                <button type="button" className="yellow-btn" onClick={handleSubmit}>
